...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" src="/scripts/tableSearchBar.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/jquery.multiselect.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/dashboard-billing-cost-report.js?v=${versionTimeStamp}"></script>
