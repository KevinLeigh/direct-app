...
<head>
    ...
    <link rel="stylesheet" href="/css/direct/fullcalendar-1.5.2.css?v=${versionTimeStamp}" media="all" type="text/css" />
    <script type="text/javascript" src="/scripts/fullcalendar-1.5.2.min.js?v=${versionTimeStamp}"></script>
</head>
