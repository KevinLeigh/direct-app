...
<head>
    ...
    <link rel="stylesheet" href="/css/direct/newCockpitProject.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <link rel="stylesheet" href="/css/direct/projectCreateFlows.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <!--[if IE 7]>
    <link rel="stylesheet" type="text/css" media="screen" href="/css/direct/newCockpitProject-ie7.css?v=${versionTimeStamp}"/>
    <link rel="stylesheet" type="text/css" media="screen" href="/css/direct/projectCreateFlows-ie7.css?v=${versionTimeStamp}" />
    <![endif]-->
    ...
    <script type="text/javascript" src="/scripts/project-create-flow-custom.js?v=${versionTimeStamp}"></script>
