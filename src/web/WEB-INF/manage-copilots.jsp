...
<head>
    ...
    <link rel="stylesheet" href="/css/direct/manageCopilots.css?v=${versionTimeStamp}" media="all" type="text/css" />
    <link rel="stylesheet" href="/css/direct/permissions.css?v=${versionTimeStamp}" media="all" type="text/css" />
    <script type="text/javascript" src="/scripts/manageCopilots.js?v=${versionTimeStamp}"></script>
</head>
