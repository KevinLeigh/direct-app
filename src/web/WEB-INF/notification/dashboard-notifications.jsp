...
<head>
    ...
    <script type="text/javascript" src="/scripts/notifications.js?v=${versionTimeStamp}"></script>
  <link rel="stylesheet" href="/css/direct/modal.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <link rel="stylesheet" href="/css/direct/ui.dialog.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <link rel="stylesheet" href="/css/direct/ui.theme.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <link rel="stylesheet" href="/css/direct/ui.core.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <link rel="stylesheet" href="/css/direct/permissions.css?v=${versionTimeStamp}" media="all" type="text/css"/>

    <script type="text/javascript" id ="js-ui" src="/scripts/ui.dialog.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" id="js-ajax" src="/scripts/AjaxPermissionProcessor.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" id="jquery-dt"src="/scripts/jquery.dataTables.min.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" id="dt-extend" src="/scripts/dataTable.extend.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" id="ptable" src="/scripts/permissionTable.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" id="pDialog" src="/scripts/permissionDialog.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" id="json" src="/scripts/json2.js?v=${versionTimeStamp}"></script>
