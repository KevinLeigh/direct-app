...
<head>
    ...
    <script type="text/javascript" src="/scripts/launch/pages/review.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/launch/pages/orderReview.js?v=${versionTimeStamp}"></script>
