...
<head>
    ...
    <link rel="stylesheet" href="/css/direct/old_homepage.css?v=${versionTimeStamp}" media="all" type="text/css"/>
   ...
   <!--[if IE 6]>
    ...
    <!--[if IE 6]>
        ...
        <script type="text/javascript" src="/scripts/ie6.js?v=${versionTimeStamp}"></script>
    <![endif]-->
    ...
    <script type="text/javascript" src="/scripts/old_scripts.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/AJAXProcessor.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/RSSProcessor.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/FeedLoader.js?v=${versionTimeStamp}"></script>
