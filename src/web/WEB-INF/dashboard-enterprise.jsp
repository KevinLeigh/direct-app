...
<head>
    ...
    <link rel="stylesheet" href="/css/direct/jquery.multiSelect.css?v=${versionTimeStamp}" media="all" type="text/css"/>
    <!--[if IE 7]>
    ...
    <script type="text/javascript" src="/scripts/dashboard-chart.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/dashboard-view.js?v=${versionTimeStamp}"></script>
    <script type="text/javascript" src="/scripts/dashboard-chart-range.js?v=${versionTimeStamp}"></script>
